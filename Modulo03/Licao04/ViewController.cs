...
namespace Licao04
{
    public partial class ViewController : UIViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            string htmlString = "<HTML><BODY BGCOLOR=BLUE><p><center><h1>Hola Web Embebido</h1></center></p></body></html>";
            ...
            Selector.ValueChanged += (s, e) =>
            {
                ...
                {
                    case 0: Mapa.MapType = MapKit.MKMapType.Standard; break;
                    case 1: Mapa.MapType = MapKit.MKMapType.Satellite; break;
                    case 2: Mapa.MapType = MapKit.MKMapType.Hybrid; break;
                }
            };
